...
const { buyrole1, buyrole2, buyrole3, buyrole4, buylogs, owner, probot, price1, price2, price3, price4, prefix,subend, time1, time2, time3, time4, webhookurl } = require('./config.json');
